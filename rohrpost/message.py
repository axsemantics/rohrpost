...
def send_message(*, message, handler, message_id=None, close=False, error=None, **additional_data):
...
def send_success(*, message, handler, message_id, close=False, **additional_data):
    ...
    send_message(message=message, message_id=message_id, handler=handler, close=close, **additional_data)
...
def send_error(*, message, handler, message_id, error, close=False, **additional_data):
    ...
    """
    send_message(message=message, message_id=message_id, handler=handler, error=error, close=close, **additional_data)
